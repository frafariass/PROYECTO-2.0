 ...
 * @author lordp
 */
@WebServlet(name = "CatalogoFamilia", urlPatterns = {"/CatalogoFamilia"})
public class CatalogoFamilia extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(String.valueOf(request.getParameter("dato").charAt(0)));
